...
extension AdminView {
    func setLocalizedTitles(with viewModel: AdminViewModel) {
        lblTitle.text = viewModel.title
        tfEmail.setupPlaceholder(placeholder: viewModel.emailPlaceholder,
...
public final class AdminView: UIView, Layoutable {
    ...
    public func setupViews() {
        ...
        [lblTitle, tfEmail, tfPassword, btnUseSms].forEach {
